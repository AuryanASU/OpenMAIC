      ...
      <div className="flex gap-1.5 items-center py-1.5 px-1">
        <span
          className={cn(
            ...
            isTeacher
              ? 'bg-[#8C1D40]/70 dark:bg-[#C75B7A]/70'
  ...
  return (
    <div
      className={cn(
        ...
        isUser
          ? 'bg-gradient-to-br from-[#8C1D40] to-[#7A1938] dark:from-[#C75B7A] dark:to-[#B04A68] text-white rounded-tr-sm shadow-sm shadow-[#8C1D40]/30 dark:shadow-[#C75B7A]/50 ring-1 ring-[#8C1D40]/20'
          : isTeacher
          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                isActiveBubble &&
                  'border-l-[#8C1D40] dark:border-l-[#C75B7A] bg-[#8C1D40]/5 dark:bg-[#C75B7A]/20',
              )}
            >
              {/* Mini Avatar */}
                ...
                <span
                  className={cn(
                    ...
                    isUser
                      ...
                      : isTeacher
                        ? 'text-[#8C1D40]/80 dark:text-[#C75B7A]/80'
