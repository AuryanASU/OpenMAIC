        ...
        >
                ...
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg px-2 py-2.5 flex flex-col items-center gap-1.5">
                  ...
                  <input
                    ...
                    className={cn(
                      ...
                      '[&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[#8C1D40] [&::-webkit-slider-thumb]:dark:bg-[#C75B7A]',
                      '[&::-webkit-slider-thumb]:shadow-sm [&::-webkit-slider-thumb]:cursor-pointer',
                      '[&::-moz-range-thumb]:w-3 [&::-moz-range-thumb]:h-3',
                      '[&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-[#8C1D40] [&::-moz-range-thumb]:border-0',
                    )}
                  />
                </div>
                {/* Arrow pointing down */}
                ...
                <TooltipTrigger asChild>
                  <button
                    ...
                    className={cn(
                      ...
                      'active:scale-90',
                      playbackSpeed !== 1
                        ? 'text-[#8C1D40] dark:text-[#C75B7A] bg-[#8C1D40]/10 dark:bg-[#C75B7A]/10'
          ...
          >
            ...
            {!whiteboardOpen && whiteboardElementCount > 0 && (
              <span className="absolute top-0.5 right-0.5 w-1.5 h-1.5 bg-[#8C1D40] dark:bg-[#C75B7A] rounded-full" />
            )}
          </button>
        </div>
      </div>
