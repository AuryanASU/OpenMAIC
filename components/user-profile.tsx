  ...
  return (
    <Card className="p-5 !gap-0 shadow-xl border-muted/40 backdrop-blur-xl bg-white/80 dark:bg-slate-900/80">
      ...
      <div className="flex items-center gap-3.5">
        ...
        >
          <div className="size-11 rounded-full bg-gray-50 dark:bg-gray-800 overflow-hidden ring-2 ring-[#8C1D40]/50 dark:ring-[#C75B7A]/40 group-hover/avatar:ring-[#8C1D40] dark:group-hover/avatar:ring-[#C75B7A] transition-all">
          ...
          {editingName ? (
            <div className="flex items-center gap-1.5">
              <input
                ...
                className="flex-1 min-w-0 h-7 bg-transparent border-b-2 border-[#8C1D40] dark:border-[#C75B7A] text-sm font-semibold text-foreground outline-none placeholder:text-muted-foreground/40"
              />
              <button
                onClick={commitName}
                className="shrink-0 size-6 rounded-md flex items-center justify-center text-[#8C1D40] hover:bg-[#8C1D40]/10 dark:hover:bg-[#C75B7A]/30 transition-colors"
              >
              ...
              {AVATAR_OPTIONS.map((url) => (
                <button
                  ...
                  className={cn(
                    ...
                    avatar === url
                      ? 'ring-2 ring-[#8C1D40] dark:ring-[#C75B7A] ring-offset-1 ring-offset-white dark:ring-offset-slate-900'
              ...
              <label
                ...
                className={cn(
                  ...
                  isCustomAvatar(avatar)
                    ? 'ring-2 ring-[#8C1D40] dark:ring-[#C75B7A] ring-offset-1 ring-offset-white dark:ring-offset-slate-900 border-[#8C1D40]/40 dark:border-[#C75B7A]/60 bg-[#8C1D40]/10 dark:bg-[#C75B7A]/30'
