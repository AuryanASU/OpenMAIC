                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isSendCooldown
                        ...
                        : 'bg-[#8C1D40] hover:bg-[#7A1938] shadow-[0_4px_16px_rgba(140,29,64,0.3)]',
                    )}
                  >
                    {isSendCooldown ? (
              ...
              >
                <div className="flex items-center gap-4 bg-white/70 dark:bg-black/60 backdrop-blur-xl rounded-full px-5 py-3 shadow-[0_8px_32px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-gray-200/60 dark:border-white/10">
                  ...
                  <div className="flex items-center gap-0.5 h-8">
                    <VoiceWaveformBars barClassName="bg-gradient-to-t from-[#8C1D40] to-[#C75B7A]" />
                  </div>
                  <span className="text-[11px] font-semibold tracking-wider text-[#8C1D40] dark:text-[#C75B7A] uppercase">
                  ...
                  >
                    <div className="relative w-12 h-12 rounded-full bg-gradient-to-br from-[#8C1D40] to-[#6B1530] shadow-[0_4px_20px_rgba(140,29,64,0.3)] flex items-center justify-center group-hover:scale-105 transition-transform duration-300 border border-white/20">
                      <Mic className="w-5 h-5 text-white" />
                    </div>
                    <div className="absolute inset-0 rounded-full border-2 border-[#8C1D40] opacity-40 animate-[ping_2s_ease-in-out_infinite]" />
                  </button>
                </div>
              </motion.div>
            )}
                ...
                <div className="flex gap-1">
                  {[0, 0.2, 0.4].map((delay) => (
                    <motion.div
                      ...
                      className="w-1.5 h-1.5 rounded-full bg-[#8C1D40]/70"
                    />
                  ))}
                </div>
                      ...
                      <div className="flex items-center gap-[3px]">
                        {[0, 1, 2].map((i) => (
                          <motion.div
                            ...
                            className="w-[3px] h-[3px] rounded-full bg-[#8C1D40]/70"
                          />
                        ))}
                      </div>
                    </div>
                        ...
                        className={cn(
                          ...
                          isCueUser
                            ...
                            : activeRole === 'user' || isInputOpen
                              ? 'border-[#8C1D40] shadow-[0_0_6px_rgba(140,29,64,0.3)]'
                              : 'border-gray-300/40 dark:border-white/20 group-hover:border-[#8C1D40]/50',
                        )}
                      />
                      <div className="w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-800 overflow-hidden relative z-10 text-lg">
    ...
    >
      ...
      <div className="flex-1 flex items-stretch min-h-0">
        ...
        >
          ...
          <div className="absolute top-0 inset-x-0 h-16 bg-gradient-to-b from-[#8C1D40]/5 dark:from-[#C75B7A]/10 to-transparent pointer-events-none" />
          <div className="absolute top-3 inset-x-0 flex flex-col items-center justify-center gap-1 opacity-10 pointer-events-none">
            <BookOpen size={20} className="text-[#8C1D40] dark:text-[#C75B7A]" />
            <div className="w-8 h-0.5 bg-[#8C1D40] dark:bg-[#C75B7A] rounded-full" />
          </div>
                    ...
                    >
                      <div
                        className={cn(
                          ...
                          activeRole === 'teacher'
                            ? 'border-[#8C1D40] dark:border-[#C75B7A] shadow-[0_0_12px_rgba(140,29,64,0.4)]'
                            : 'border-gray-200 dark:border-gray-700 group-hover:border-[#8C1D40]/40 dark:group-hover:border-[#C75B7A]',
                        )}
                      />
                    ...
                    <span
                      className={cn(
                        ...
                        activeRole === 'teacher' && !speakingStudent
                          ? 'text-[#8C1D40] dark:text-[#C75B7A] border-[#8C1D40]/30 dark:border-[#C75B7A]/40'
                          : 'text-gray-400 dark:text-gray-500 border-gray-100 dark:border-gray-700 group-hover:text-[#8C1D40] dark:group-hover:text-[#C75B7A] group-hover:border-[#8C1D40]/30 dark:group-hover:border-[#C75B7A]',
                      )}
                    >
                      {teacherName}
                    </span>
          ...
          >
            ...
            <AnimatePresence>
              {isInputOpen && (
                ...
                >
                  <div className="relative w-fit max-w-[85%] sm:max-w-[65%] min-w-[200px] sm:min-w-[300px] bg-white/90 dark:bg-gray-800/90 backdrop-blur-md p-2 pr-2 rounded-2xl rounded-br-none shadow-2xl border border-[#8C1D40]/30 dark:border-[#C75B7A]/40 flex items-end gap-2 ring-1 ring-[#8C1D40]/10 dark:ring-[#C75B7A]/20">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isSendCooldown
                          ...
                          : 'bg-[#8C1D40] hover:bg-[#7A1938] dark:bg-[#C75B7A] dark:hover:bg-[#B04A68] shadow-[#8C1D40]/30 dark:shadow-[#C75B7A]/50',
                      )}
                    >
                      {isSendCooldown ? (
              ...
              {isVoiceOpen && (
                ...
                >
                  <div className="flex flex-col-reverse items-end gap-1 mr-[-10px] relative z-20">
                    <div className="flex items-center gap-0.5 h-8 px-2 py-1.5 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-xl border border-[#8C1D40]/10 dark:border-[#C75B7A]/30 shadow-sm">
                      <VoiceWaveformBars barClassName="bg-gradient-to-t from-[#8C1D40] to-[#6B1530] dark:from-[#C75B7A] dark:to-[#A04060]" />
                    </div>
                    <motion.div
                      initial={{ opacity: 0, x: 10 }}
                      animate={{ opacity: 1, x: 0 }}
                      className="text-[10px] font-bold tracking-widest text-[#8C1D40] dark:text-[#C75B7A] uppercase bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm px-2 py-0.5 rounded-full shadow-sm border border-[#8C1D40]/10 dark:border-[#C75B7A]/20 mr-1"
                    >
                      {isProcessing ? t('roundtable.processing') : t('roundtable.listening')}
                    </motion.div>
                  </div>
                  ...
                  <div
                    ...
                    onClick={handleToggleVoice}
                  >
                    <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-[#8C1D40] to-[#6B1530] dark:from-[#C75B7A] dark:to-[#A04060] shadow-[0_4px_20px_rgba(140,29,64,0.3)] flex items-center justify-center z-20 group-hover:scale-105 transition-transform duration-300 border border-white/20 dark:border-white/10">
                      <Mic className="w-6 h-6 text-white" />
                    </div>
                    <div className="absolute inset-0 rounded-full border-2 border-[#8C1D40] dark:border-[#C75B7A] opacity-40 animate-[ping_2s_ease-in-out_infinite] z-10" />
                    ...
                    <div className="absolute inset-0 bg-[#8C1D40] dark:bg-[#C75B7A] blur-2xl opacity-20 group-hover:opacity-40 transition-opacity z-0" />
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
                ...
                >
                  <div className="flex gap-1">
                    <motion.div
                      ...
                      className="w-1.5 h-1.5 rounded-full bg-[#8C1D40]"
                    />
                    <motion.div
                      animate={{ opacity: [0.3, 1, 0.3] }}
                      transition={{
                    ...
                    <div
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'bg-[#8C1D40]/[0.08] dark:bg-[#C75B7A]/[0.06]',
                      )}
                    />
                    ...
                    <motion.div
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'border-[#8C1D40]/50 dark:border-[#C75B7A]/35',
                      )}
                    />
                    {/* Expanding ripple 2 */}
                    <motion.div
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'border-[#8C1D40]/40 dark:border-[#C75B7A]/25',
                      )}
                    />
                    ...
                    <motion.button
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'from-[#8C1D40] to-[#6B1530] dark:from-[#C75B7A] dark:to-[#A04060] shadow-[#8C1D40]/30 dark:shadow-[#C75B7A]/20 hover:shadow-[#8C1D40]/40 dark:hover:shadow-[#C75B7A]/30',
                      )}
                    >
                      {asrEnabled ? (
                    ...
                    <div className="flex items-center justify-center gap-[3px] h-3">
                      {[0, 1, 2, 3, 2, 1, 0].map((intensity, i) => (
                        <motion.div
                          ...
                          className="w-[2.5px] h-full origin-center rounded-full bg-[#8C1D40]/60 dark:bg-[#C75B7A]/50"
                        />
                      ))}
                    </div>
                  )}
                  ...
                  <motion.span
                    ...
                    className={cn(
                      ...
                      asrEnabled
                        ...
                        : 'text-[#8C1D40]/70 dark:text-[#C75B7A]/60',
                    )}
                  >
                    {t('roundtable.yourTurn')}
                  </motion.span>
                  ...
                  >
                    <div
                      ...
                      className={cn(
                        ...
                        bubbleRole === 'user'
                          ? 'bg-[#8C1D40]/95 dark:bg-[#C75B7A]/95 backdrop-blur-sm border-[#8C1D40]/40 dark:border-[#C75B7A]/40 text-white rounded-br-sm shadow-md shadow-[#8C1D40]/30 dark:shadow-[#C75B7A]/30'
                          : bubbleRole === 'agent'
                            ? cn(
                    ...
                    >
                            ...
                            >
                              <div
                                className={cn(
                                  ...
                                  bubbleRole === 'user'
                                    ? 'border-[#8C1D40] dark:border-[#C75B7A]'
                                    : bubbleRole === 'agent'
                                      ? 'border-blue-300 dark:border-blue-600'
                                      : 'border-[#8C1D40]/30 dark:border-[#C75B7A]/40',
                                )}
                              >
                      ...
                      {bubbleRole !== 'user' &&
                        ...
                        (() => {
                          ...
                          if (btnState === 'play') {
                            return (
                              <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 hover:bg-[#8C1D40]/10 dark:hover:bg-[#C75B7A]/20 group-hover/bubble:bg-[#8C1D40]/10 dark:group-hover/bubble:bg-[#C75B7A]/20 transition-all duration-300 cursor-pointer">
                                <Play className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 hover:text-[#8C1D40] dark:hover:text-[#C75B7A] group-hover/bubble:text-[#8C1D40] dark:group-hover/bubble:text-[#C75B7A] ml-0.5" />
                              </div>
                            );
                          }
                          ...
                          if (btnState === 'restart') {
                            return (
                              <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 hover:bg-[#8C1D40]/10 dark:hover:bg-[#C75B7A]/20 group-hover/bubble:bg-[#8C1D40]/10 dark:group-hover/bubble:bg-[#C75B7A]/20 transition-all duration-300 cursor-pointer">
                                <Repeat className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 hover:text-[#8C1D40] dark:hover:text-[#C75B7A] group-hover/bubble:text-[#8C1D40] dark:group-hover/bubble:text-[#C75B7A]" />
                              </div>
                            );
                          }
                          ...
                          // btnState === 'bars'
                          return (
                            <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 group-hover/bubble:bg-[#8C1D40]/10 dark:group-hover/bubble:bg-[#C75B7A]/20 transition-all duration-300">
                              {isDiscussionPaused ? (
                                /* Paused: static Play icon */
                                <Play className="w-3.5 h-3.5 text-amber-500 dark:text-amber-400 group-hover/bubble:text-[#8C1D40] dark:group-hover/bubble:text-[#C75B7A] ml-0.5" />
                              ) : (
                                <>
                                  ...
                                  {/* Pause icon on hover */}
                                  <Pause className="w-3.5 h-3.5 text-[#8C1D40] dark:text-[#C75B7A] hidden group-hover/bubble:block" />
                                </>
                              )}
                            </div>
                          );
                          ...
                          >
                            <div
                              className={cn(
                                'absolute inset-0 rounded-full border-2 transition-all duration-300',
                                isSpeaking
                                  ? 'border-[#8C1D40] dark:border-[#C75B7A] shadow-[0_0_8px_rgba(140,29,64,0.4)]'
                            ...
                            {isThinkingAgent && (
                              <div className="absolute inset-0 rounded-full border-2 border-[#8C1D40] border-t-transparent animate-spin z-20" />
                            )}
                          </div>
                        </HoverCardTrigger>
                        <HoverCardContent
                  ...
                  <div className="flex items-center gap-[3px]">
                    {[0, 1, 2].map((i) => (
                      <motion.div
                        ...
                        className="w-[4px] h-[4px] rounded-full bg-[#8C1D40]/70 dark:bg-[#C75B7A]"
                      />
                    ))}
                  </div>
                </div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      !asrEnabled
                        ...
                        : isVoiceOpen
                          ? 'bg-[#8C1D40] dark:bg-[#C75B7A] border-[#8C1D40] dark:border-[#C75B7A] text-white shadow-[#8C1D40]/30 dark:shadow-[#C75B7A]/40'
                          : 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-400 dark:text-gray-500 hover:bg-[#8C1D40]/10 dark:hover:bg-[#C75B7A]/20 hover:text-[#8C1D40] dark:hover:text-[#C75B7A] hover:border-[#8C1D40]/30 dark:hover:border-[#C75B7A]/40',
                    )}
                  >
                    {asrEnabled ? (
                ...
                <div
                  className={cn(
                    ...
                    isCueUser
                      ...
                      : activeRole === 'user' || isInputOpen
                        ? 'border-[#8C1D40] dark:border-[#C75B7A] shadow-[0_0_8px_rgba(140,29,64,0.3)]'
                        : 'border-white dark:border-gray-700 group-hover:border-[#8C1D40]/30 dark:group-hover:border-[#C75B7A]',
                  )}
                />
