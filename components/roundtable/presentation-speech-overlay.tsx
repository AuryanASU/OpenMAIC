    ...
    <div className="flex items-center gap-2" onClick={onExpand}>
      <div
        className={cn(
          ...
          bubble.role === 'user'
            ? 'bg-[#8C1D40]/10 dark:bg-[#C75B7A]/15 border-[#8C1D40]/20 dark:border-[#C75B7A]/30'
            : bubble.role === 'agent'
      ...
      >
        <div
          className={cn(
            ...
            bubble.role === 'user'
              ? 'border-[#8C1D40]/40 dark:border-[#C75B7A]/60'
              : bubble.role === 'agent'
      ...
      {onPlayPause && (
        <div
          ...
          className={cn(
            ...
            'hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]',
            bubble.role === 'user'
              ? 'bg-[#8C1D40]/10 dark:bg-[#C75B7A]/15 border-[#8C1D40]/20 dark:border-[#C75B7A]/30 hover:bg-[#8C1D40]/10 dark:hover:bg-[#C75B7A]/20'
              : bubble.role === 'agent'
  ...
  return (
    <div
      ...
      className={cn(
        ...
        bubble.role === 'user'
          ? 'bg-[#8C1D40]/8 dark:bg-[#C75B7A]/12 border-[#8C1D40]/20 dark:border-[#C75B7A]/30'
          : bubble.role === 'agent'
    ...
    >
      ...
      {bubble.role !== 'user' &&
        ...
        buttonState !== 'none' &&
        (() => {
          const barsColor = bubble.role === 'agent' ? '#3b82f6' : '#8C1D40';
          ...
          if (buttonState === 'play') {
            return (
              <div
                ...
                className="absolute right-2.5 bottom-2.5 z-20 p-1.5 rounded-full bg-white/40 dark:bg-gray-800/40 backdrop-blur-sm group-hover/bubble:bg-[#8C1D40]/10 dark:group-hover/bubble:bg-[#C75B7A]/20 transition-all duration-300 cursor-pointer"
              >
                <Play className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 group-hover/bubble:text-[#8C1D40] dark:group-hover/bubble:text-[#C75B7A] ml-0.5" />
              </div>
            );
          }
          ...
          if (buttonState === 'restart') {
            return (
              <div
                ...
                className="absolute right-2.5 bottom-2.5 z-20 p-1.5 rounded-full bg-white/40 dark:bg-gray-800/40 backdrop-blur-sm group-hover/bubble:bg-[#8C1D40]/10 dark:group-hover/bubble:bg-[#C75B7A]/20 transition-all duration-300 cursor-pointer"
              >
                <Repeat className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 group-hover/bubble:text-[#8C1D40] dark:group-hover/bubble:text-[#C75B7A]" />
              </div>
            );
          }
