      ...
      <div className="space-y-4">
        ...
        {agentMode === 'preset' ? (
          <>
              ...
              className={`p-3 rounded-lg text-sm ${
                selectedAgentIds.length === 0
                  ...
                  : selectedAgentIds.length === 1
                    ...
                    : 'bg-[#8C1D40]/10 dark:bg-[#C75B7A]/20 text-[#8C1D40] dark:text-[#C75B7A] border border-[#8C1D40]/30 dark:border-[#C75B7A]/40'
              }`}
            >
              {selectedAgentIds.length === 0 && (
            ...
            {selectedAgentIds.length > 1 && (
              <div className="space-y-2 border-l-4 border-[#8C1D40] pl-4">
