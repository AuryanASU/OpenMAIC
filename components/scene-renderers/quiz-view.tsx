  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center gap-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 p-6 opacity-[0.03]">
        <PieChart className="w-52 h-52 text-[#8C1D40]" />
      </div>
      <div className="absolute bottom-0 left-0 p-6 opacity-[0.02]">
        <BookOpenText className="w-40 h-40 text-[#8C1D40] rotate-12" />
      </div>
      ...
      >
        <PieChart className="w-8 h-8 text-[#8C1D40]" />
      </motion.div>
      ...
      >
        <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
          <div className="w-7 h-7 rounded-lg bg-[#8C1D40]/10 dark:bg-[#C75B7A]/30 flex items-center justify-center">
            <BookOpenText className="w-3.5 h-3.5 text-[#8C1D40]" />
          </div>
          <span>
        ...
        <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
          <div className="w-7 h-7 rounded-lg bg-[#8C1D40]/10 dark:bg-[#C75B7A]/30 flex items-center justify-center">
            <PieChart className="w-3.5 h-3.5 text-[#8C1D40]" />
          </div>
          <span>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={onStart}
        className="mt-1 px-8 py-2.5 bg-gradient-to-r from-[#8C1D40] to-[#7A1938] text-white rounded-full font-medium shadow-lg shadow-[#8C1D40]/30 dark:shadow-[#C75B7A]/50 hover:shadow-[#8C1D40]/40 transition-shadow z-10 flex items-center gap-2"
      >
        {t('quiz.startQuiz')}
          ...
          return (
            <button
              ...
              className={cn(
                ...
                !isReview &&
                  !selected &&
                  'border-gray-200 dark:border-gray-600 hover:border-[#8C1D40]/30 dark:hover:border-[#C75B7A]/40 hover:bg-[#8C1D40]/5 dark:hover:bg-[#C75B7A]/30',
                !isReview &&
                  selected &&
                  'border-[#8C1D40] bg-[#8C1D40]/10 dark:bg-[#C75B7A]/30 ring-1 ring-[#8C1D40]/30 dark:ring-[#C75B7A]/40',
                // Review states
                isReview &&
                  isCorrectOpt &&
            ...
            >
              <span
                className={cn(
                  ...
                  !isReview && selected && 'bg-[#8C1D40] text-white',
              ...
              <span
                className={cn(
                  ...
                  !isReview &&
                    !isSelected &&
                    'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400',
                  !isReview && isSelected && 'bg-[#8C1D40] text-white',
                  isReview && isCorrectOpt && 'bg-emerald-500 text-white',
    ...
    <QuestionCard question={question} index={index} result={result}>
      {!isReview ? (
        ...
        <div className="space-y-3">
          ...
          {result.aiComment && (
            <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-[#8C1D40]/10 dark:bg-[#C75B7A]/30 border border-[#8C1D40]/10 dark:border-[#C75B7A]/40">
              <Sparkles className="w-4 h-4 text-[#8C1D40] shrink-0 mt-0.5" />
              <div>
                <p className="text-xs font-medium text-[#8C1D40] dark:text-[#C75B7A] mb-0.5">
                  {t('quiz.aiComment')}
                </p>
                <p className="text-xs text-[#8C1D40]/80 dark:text-[#C75B7A]/80">
                  {result.aiComment}
                </p>
              </div>
              <span className="ml-auto text-xs font-bold text-[#8C1D40] dark:text-[#C75B7A] shrink-0">
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-gray-100 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur shrink-0">
              <div className="flex items-center gap-2">
                <PieChart className="w-4 h-4 text-[#8C1D40]" />
