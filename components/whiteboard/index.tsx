      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute inset-4 pointer-events-auto bg-white/95 dark:bg-gray-800/95 backdrop-blur-2xl rounded-3xl shadow-[0_32px_80px_-20px_rgba(0,0,0,0.25)] border-2 border-[#8C1D40]/20 dark:border-[#C75B7A]/60 flex flex-col overflow-hidden z-[120] ring-4 ring-[#8C1D40]/10 dark:ring-[#C75B7A]/40"
          >
            {/* Header */}
            <div className="h-14 px-6 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between shrink-0 bg-white/50 dark:bg-gray-800/50">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-xl bg-[#8C1D40]/10 dark:bg-[#C75B7A]/30 flex items-center justify-center text-[#8C1D40] dark:text-[#C75B7A]">
              ...
              <div className="flex items-center gap-2">
                <AnimatePresence>
                  {viewModified && (
                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      className="p-2 text-gray-400 dark:text-gray-500 hover:text-[#8C1D40] dark:hover:text-[#C75B7A] hover:bg-[#8C1D40]/10 dark:hover:bg-[#C75B7A]/20 rounded-lg transition-colors"
                ...
                <div className="relative">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="relative p-2 text-gray-400 dark:text-gray-500 hover:text-[#8C1D40] dark:hover:text-[#C75B7A] hover:bg-[#8C1D40]/10 dark:hover:bg-[#C75B7A]/20 rounded-lg transition-colors"
                    title={t('whiteboard.history')}
                  >
                    <History className="w-4 h-4" />
                    {snapshotCount > 0 && (
                      <span className="absolute -top-0.5 -right-0.5 min-w-[16px] h-4 px-1 rounded-full bg-[#8C1D40] text-white text-[10px] font-bold flex items-center justify-center">
                        {snapshotCount}
                      </span>
                    )}
                  </motion.button>
