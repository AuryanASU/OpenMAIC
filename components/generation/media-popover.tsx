      ...
      <PopoverTrigger asChild>
        <button
          className={cn(
            ...
            enabledCount > 0
              ? 'bg-[#8C1D40]/10 dark:bg-[#C75B7A]/30 text-[#8C1D40] dark:text-[#C75B7A] border-[#8C1D40]/20 dark:border-[#C75B7A]/50'
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {isEnabled && !isActive && (
                    <span className="absolute top-1 right-1 size-1.5 rounded-full bg-[#8C1D40]" />
                  )}
                </button>
              );
            })}
      ...
      <div className="flex items-center gap-2.5">
        <Icon
          className={cn(
            ...
            enabled ? 'text-[#8C1D40] dark:text-[#C75B7A]' : 'text-muted-foreground/50',
          )}
        />
        <span
          className={cn(
