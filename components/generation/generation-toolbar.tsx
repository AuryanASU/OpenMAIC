          ...
          <PopoverTrigger asChild>
            <button
              className={cn(
                ...
                currentModelId &&
                  'ring-[#8C1D40]/40 dark:ring-[#C75B7A]/40 bg-[#8C1D40]/10 dark:bg-[#C75B7A]/20',
              )}
            >
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isActive ? 'bg-[#8C1D40]/5 dark:bg-[#C75B7A]/10' : 'hover:bg-muted/50',
                  )}
                >
                  {provider.icon ? (
                    <img
            ...
            {activeProvider.models.map((model) => {
              ...
              return (
                ...
                >
                  ...
                  {isSelected && (
                    <Check className="size-3.5 shrink-0 text-[#8C1D40] dark:text-[#C75B7A]" />
                  )}
                </button>
              );
            })}
