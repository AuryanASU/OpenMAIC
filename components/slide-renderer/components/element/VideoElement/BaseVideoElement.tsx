    ...
    >
      ...
      >
        {showDisabled ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-indigo-50 via-[#8C1D40]/5 to-blue-50 dark:from-indigo-950/40 dark:via-[#C75B7A]/10 dark:to-blue-950/20 flex items-center justify-center rounded">
            <style>{`
